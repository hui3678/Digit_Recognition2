/**
  ******************************************************************************
  * @file    digit_recognition_model.h
...
#ifndef AI_DIGIT_RECOGNITION_MODEL_H
#define AI_DIGIT_RECOGNITION_MODEL_H
#pragma once
...
/******************************************************************************/
#define AI_DIGIT_RECOGNITION_MODEL_MODEL_NAME          "digit_recognition_model"
#define AI_DIGIT_RECOGNITION_MODEL_ORIGIN_MODEL_NAME   "digit_recognition"

/******************************************************************************/
#define AI_DIGIT_RECOGNITION_MODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_DIGIT_RECOGNITION_MODEL_IN_NUM        (1)
#define AI_DIGIT_RECOGNITION_MODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 1, 28, 1, NULL), \
}
#define AI_DIGIT_RECOGNITION_MODEL_IN_SIZE { \
  AI_DIGIT_RECOGNITION_MODEL_IN_1_SIZE, \
}
#define AI_DIGIT_RECOGNITION_MODEL_IN_SIZE_BYTES { \
  AI_DIGIT_RECOGNITION_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_DIGIT_RECOGNITION_MODEL_IN_1_HEIGHT      (28)
#define AI_DIGIT_RECOGNITION_MODEL_IN_1_WIDTH       (1)
#define AI_DIGIT_RECOGNITION_MODEL_IN_1_CHANNEL     (28)
#define AI_DIGIT_RECOGNITION_MODEL_IN_1_SIZE        (28 * 1 * 28)
#define AI_DIGIT_RECOGNITION_MODEL_IN_1_SIZE_BYTES  (AI_DIGIT_RECOGNITION_MODEL_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_DIGIT_RECOGNITION_MODEL_OUT_NUM       (1)
#define AI_DIGIT_RECOGNITION_MODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_DIGIT_RECOGNITION_MODEL_OUT_SIZE { \
  AI_DIGIT_RECOGNITION_MODEL_OUT_1_SIZE, \
}
#define AI_DIGIT_RECOGNITION_MODEL_OUT_SIZE_BYTES { \
  AI_DIGIT_RECOGNITION_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_DIGIT_RECOGNITION_MODEL_OUT_1_HEIGHT      (1)
#define AI_DIGIT_RECOGNITION_MODEL_OUT_1_WIDTH       (1)
#define AI_DIGIT_RECOGNITION_MODEL_OUT_1_CHANNEL     (10)
#define AI_DIGIT_RECOGNITION_MODEL_OUT_1_SIZE        (1 * 1 * 10)
#define AI_DIGIT_RECOGNITION_MODEL_OUT_1_SIZE_BYTES  (AI_DIGIT_RECOGNITION_MODEL_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_DIGIT_RECOGNITION_MODEL_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup digit_recognition_model
 ...
 * @ingroup digit_recognition_model
 ...
 * @ref ai_digit_recognition_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_digit_recognition_model_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_DIGIT_RECOGNITION_MODEL_*
 * defines into file @ref digit_recognition_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_digit_recognition_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_DIGIT_RECOGNITION_MODEL_H */
